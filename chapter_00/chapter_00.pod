...
generally be used as it will make your XS code faster when run
under threaded perls, without any additional work, I<unless>
you define helper C functions in your XS file (and even in that case
